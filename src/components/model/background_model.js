...
export function BackGroundModel({ backgroundRef, handleClickPhoto }) {
    const { nodes, materials } = useGLTF("/assets/background/scene.gltf");
    return (
        <group dispose={null} ref={backgroundRef}>
            <group scale={0.01}>
                <group
                ...
                <group
                    ...
                    rotation={[Math.PI / 2, Math.PI / 2, 0]}
                    scale={0.666}
					onClick={() => handleClickPhoto('contact')}
                >
                    <mesh
                ...
                <group
                    ...
                    rotation={[Math.PI / 2, Math.PI / 2, 0]}
                    scale={0.666}
					onClick={() => handleClickPhoto('skills')}
                >
                    <mesh
                ...
                <mesh
                    geometry={nodes.Wood__Box001_WOOD_0.geometry}
                    material={materials.WOOD}
                    position={[-555.659, 0.45, -153.536]}
                    rotation={[-Math.PI / 2, 0, 0]}
                    scale={0.666}
                />
                <group
                    position={[-494.242, 84.081, -83.41]}
                    rotation={[-Math.PI / 2, 0, 0]}
                    scale={0.859}
                >
                    <mesh
                        geometry={nodes.Box_Glass001_glass_0.geometry}
                        material={materials.glass}
                        position={[-71.518, 81.659, 234.37]}
                    />
                </group>
                <group
                    position={[1034.179, 84.095, -148.774]}
                    rotation={[-Math.PI / 2, 0, -Math.PI / 2]}
                    scale={[2.267, 2.093, 2.267]}
                >
                    <mesh
                        geometry={nodes.Sculpture_01_SCULPTURE_0.geometry}
                        material={materials.SCULPTURE}
                        position={[-3.011, 1.021, 14.396]}
                    />
                </group>
                <group
                    position={[-560.868, 84.037, -149.824]}
                    rotation={[-Math.PI / 2, 0, -Math.PI / 2]}
                    scale={2.606}
                >
                    <mesh
                        geometry={nodes.Sculpture_02_SCULPTURE_0.geometry}
                        material={materials.SCULPTURE}
                        position={[-3.011, 1.021, 14.396]}
                    />
                </group>
                <group
                    position={[1096.64, 84.081, -83.41]}
                    rotation={[-Math.PI / 2, 0, 0]}
                    scale={0.859}
                >
                    <mesh
                        geometry={nodes.Box_Glass002_glass_0.geometry}
                        material={materials.glass}
                        position={[-71.518, 81.659, 234.37]}
                    />
                </group>
                <mesh
                    geometry={nodes.Wood__Box002_WOOD_0.geometry}
                    material={materials.WOOD}
                    position={[1035.223, 0.45, -153.536]}
                    rotation={[-Math.PI / 2, 0, 0]}
                    scale={0.666}
                />
                <group
                    position={[-1197.852, 0.311, -224.895]}
                    rotation={[-Math.PI / 2, 0, 0]}
                >
                    <group position={[-362.179, -0.537, -1.107]}>
                        <mesh
                            geometry={nodes.Sofa__Legs004_Metal_01_0.geometry}
                            material={materials.Metal_01}
                            position={[-591.078, 71.264, 35.977]}
                        />
                    </group>
                    <mesh
                        geometry={nodes.Sofa__Face004_SOFA_0.geometry}
                        material={materials.SOFA}
                        position={[-241.923, -50.378, 34.803]}
                    />
                </group>
                <group
                ...
                <group
                    position={[1693.39, 114.314, -688.709]}
                    rotation={[0, 0, 0.051]}
                >
                    <mesh
                ...
                <group
                    position={[1679.665, 114.314, 380.791]}
                    rotation={[0, 0, 0.051]}
                >
                    <mesh
                ...
                <group
                    position={[490.707, 0.311, -224.895]}
                    rotation={[-Math.PI / 2, 0, 0]}
                >
                    <group position={[-362.179, -0.537, -1.107]}>
                        <mesh
                            geometry={nodes.Sofa__Legs005_Metal_01_0.geometry}
                            material={materials.Metal_01}
                            position={[-591.078, 71.264, 35.977]}
                        />
                    </group>
                    <mesh
                        geometry={nodes.Sofa__Face005_SOFA_0.geometry}
                        material={materials.SOFA}
                        position={[-241.923, -50.378, 34.803]}
                    />
                </group>
                <group
                    position={[1903.995, 0.311, -224.895]}
                    rotation={[-Math.PI / 2, 0, 0]}
                >
                    <group position={[-362.179, -0.537, -1.107]}>
                        <mesh
                            geometry={nodes.Sofa__Legs006_Metal_01_0.geometry}
                            material={materials.Metal_01}
                            position={[-591.078, 71.264, 35.977]}
                        />
                    </group>
                    <mesh
                        geometry={nodes.Sofa__Face006_SOFA_0.geometry}
                        material={materials.SOFA}
                        position={[-241.923, -50.378, 34.803]}
                    />
                </group>
